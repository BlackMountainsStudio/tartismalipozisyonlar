...
import { Plus, Loader2, Search, Trophy } from "lucide-react";
...
export default function DashboardMatchesPage() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-6 py-8">
      <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="mt-0.5 text-sm text-zinc-400">Maçları ekleyin, düzenleyin ve yönetin</p>
          </div>
        </div>
        <button
      ...
      {showAddForm && (
        <form onSubmit={handleAddMatch} className="mb-8 rounded-xl border border-zinc-800 bg-zinc-900/50 p-6">
          <h2 className="mb-4 text-lg font-semibold text-white">Yeni Maç Ekle</h2>
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            <div>
              <label className="mb-1.5 block text-xs font-medium text-zinc-400">Ev Sahibi</label>
              <input
                type="text"
            ...
            <div>
              <label className="mb-1.5 block text-xs font-medium text-zinc-400">Deplasman</label>
              <input
                type="text"
            ...
            <div>
              <label className="mb-1.5 block text-xs font-medium text-zinc-400">Lig</label>
              <input
                type="text"
            ...
            <div>
              <label className="mb-1.5 block text-xs font-medium text-zinc-400">Hafta</label>
              <input
                type="number"
                value={formData.week}
            ...
            <div>
              <label className="mb-1.5 block text-xs font-medium text-zinc-400">Tarih</label>
              <input
                type="date"
                value={formData.date}
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-20 text-center">
          ...
          <p className="mt-1 text-sm text-zinc-500">Tartışmalı pozisyonları tespit etmek için maç ekleyin</p>
        </div>
      ) : (
